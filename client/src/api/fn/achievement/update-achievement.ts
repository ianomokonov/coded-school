...
export function updateAchievement(http: HttpClient, rootUrl: string, params: UpdateAchievement$Params, context?: HttpContext): Observable<BaseResponse<void>> {
...
updateAchievement.PATH = '/api/achievement/{id}';
